...
stanford_root = './dataset/stanford/'
hciold_root = './dataset/HCIOLD/'
...
def generate_hci_for_train(traindata_all, traindata_label, input_size, label_size, batch_size,
                                 Setting02_AngualrViews, boolmask_img4, boolmask_img6, boolmask_img15, use_v, ouc, num_img):
