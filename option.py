...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--time_str', type=str, default='', help='run date ')
        parser.add_argument('--losses', type=str, default='L1_smooth', help='run date')
        ...
        # model parameters
        parser.add_argument('--model_name', type=str, default='LFatt', help='chooses which model to use. [Refocal| LFDepth | LFatt | Packnet ]')
        # parser.add_argument('--version', type=str, default='A', help=' [A: add| B: concatenate ]')
        parser.add_argument('--n_stream', type=int, default=4, help='# of gen filters in the last conv layer')
        parser.add_argument('--n_block', type=int, default=6, help='# of gen filters in the last conv layer')
        parser.add_argument('--input_c', type=int, default=3, help='# of gen filters in the last conv layer') ##########
        parser.add_argument('--out_c', type=int, default=9, help='# of gen filters in the last conv layer') ##########
        ...
        # dataset parameters
        parser.add_argument('--dataset_file', type=str, default='LFattdata', help='[EPIdata | Refocaldata | HCIdata | Packnetdata | Refdata]')
        ...
        parser.add_argument('--num_workers', type=int, default=8, help='val imgs')
        parser.add_argument('--load_size', type=int, default=512, help='input imgs size')
